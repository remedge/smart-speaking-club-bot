...
class UserFixtures extends Fixture
{
    ...
    public const USER_ID_3 = '00000000-0000-0000-0000-000000000003';

    public const ADMIN_ID = '00000000-0000-0000-0000-000000000004';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $manager->persist(
            new User(
                id: Uuid::fromString(self::USER_ID_3),
                chatId: 333333,
                firstName: 'Ed',
                lastName: 'Traxler',
                username: 'ed_traxler',
