...
class StartCommandHandler
{
    ...
    public function __invoke(StartCommand $command): void
    {
        ...
        $text = 'Привет! Я – умный бот-помощник. Расскажу о всех предстоящих разговорных клубах и событиях, и помогу записаться на любое из них за два клика. А еще напомню о ваших предстоящих записях. 

Нажмите “📅 Посмотреть расписание“, чтобы увидеть список всех предстоящих встреч и выберите ту, на которую хотите записаться 😊';
